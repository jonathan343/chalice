...
In order to do this, you can use the `Chalice.lambda_function` decorator
...
[defined here]: https://docs.aws.amazon.com/lambda/latest/dg/python-programming-model-handler-types.html
