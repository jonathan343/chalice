...
be shared across all stages. See the [Chalice Stages](stages.md) doc for more
...
See [iam role pol examples](configfile.md#iam-role-pol-examples) for examples of how to configure IAM roles
and policies.
...
level keys. See the [env var examples](configfile.md#env-var-examples) section below for a concrete
example.
...
See [iam role pol examples](configfile.md#iam-role-pol-examples) for more examples of how to configure IAM
roles and policies.
...
per Lambda function. See [AWS Lambda Layers Configuration].

<a id="automatic-layer-option"></a>
### `automatic_layer`
...
[package 3rd party](packaging.md#package-3rd-party) for more information.

<a id="custom-domain-config-options"></a>
...
See the [Custom Domain Names](domainname.md) documentation for more information on configuring
your Chalice application with a custom domain name.

See [AWS Custom Domain names setup] for the API Gateway documentation on
configuring a custom domain name.

<a id="custom-domain-ws-config-options"></a>
...
for the given stage. For more information check out the [Service Docs](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-gzip-compression-decompression.html)
...
Documentation on managing concurrency][aws documentation on managing concurrency].
...
permissions accordingly, as described in the [AWS Lambda VPC documentation].
...
Logs docs](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_PutRetentionPolicy.html#API_PutRetentionPolicy_RequestParameters)
...
See the [stage config](configfile.md#stage-config) section above for a description
...
[aws api mapping key]: https://docs.aws.amazon.com/apigatewayv2/latest/api-reference/domainnames-domainname-apimappings.html
[aws custom domain names setup]: https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-custom-domains.html
[aws documentation on managing concurrency]: https://docs.aws.amazon.com/lambda/latest/dg/concurrent-executions.html
[aws lambda layers configuration]: https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html
[aws lambda vpc documentation]: https://docs.aws.amazon.com/lambda/latest/dg/vpc.html#vpc-configuring
