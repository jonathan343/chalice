...
[CHANGELOG.md](https://github.com/aws/chalice/blob/master/CHANGELOG.md))
file.
...
([#604](https://github.com/aws/chalice/issues/604)).
...
deprecated since v0.8.1. See [Authorization](topics/authorizers.md) for updated
information on configuring authorizers in Chalice as well as the
original deprecation notice in the [v0 8 1](upgrading.md#v0-8-1) upgrade notes.
...
of [binary content type support](https://github.com/aws/chalice/issues/348), the `raw_body` attribute
...
The [Chalice Stages](topics/stages.md) doc has more details on the new chalice stages
...
- A new `stages` key is supported in the `.chalice/config.json`. This
  ...
  See the [Configuration File](topics/configfile.md) doc for more information about stage
...
See the [Chalice Stages](topics/stages.md) doc for more details on the new chalice stages
feature.
