...
!!! warning
    ...
    See [Experimental APIs](experimental.md) for more information.
...
type [WebsocketEvent](../api.md#websocket-api). This class allows easy access to
...
You can return a dictionary or an instance of `Response` in the
...
[app.websocket_api.send()](../api.md#websocket-send) method. This method will work in any
...
See [websocket tutorial](../tutorials/index.md#websocket-tutorial) for completely worked example applications.
