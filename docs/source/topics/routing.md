...
The `Chalice.route` method is used to construct which routes
you want to create for your API. The concept is the same
mechanism used by [Flask](https://palletsprojects.com/p/flask/) and
...
`app.current_request <Chalice.current_request>` attribute. This also
