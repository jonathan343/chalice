...
[AWS SDK for Python](http://boto3.readthedocs.io/en/docs/). Chalice also
...
deployment package that contains your application and a [Terraform](https://www.terraform.io) configuration file. You can then use the
...
- You want to integrate with other Terraform resources to manage all
  ...
  chalice app.
- You'd like to integrate with [AWS CodePipeline](https://aws.amazon.com/codepipeline/) to automatically deploy
