...
[Quickstart](../quickstart.md) for a step by step guide. You can run these commands
...
ACM supports both [DNS validation](https://docs.aws.amazon.com/acm/latest/userguide/gs-acm-validate-dns.html)
as well as [email validation](https://docs.aws.amazon.com/acm/latest/userguide/gs-acm-validate-email.html).
...
[api_gateway_custom_domain](https://aws.github.io/chalice/topics/configfile.html#api-gateway-custom-domain)
...
[topic guide](../topics/domainname.md) on custom domains as well
as the config file reference for the
[custom domain config options](../topics/configfile.md#custom-domain-config-options) and the
[custom domain ws config options](../topics/configfile.md#custom-domain-ws-config-options) options.
