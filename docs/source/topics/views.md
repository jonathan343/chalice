...
- Returning an instance of `Response`. This gives you
...
`Response` class to customize the HTTP errors if you prefer to
...
python types directly. You don't need to use the `Response` class.
Chalice will automatically convert this to a JSON HTTP response as a
convenience for you.

Use the `Response` class when you want to return non-JSON content, or
...
Use the `Response` class when you want to customize the error responses
