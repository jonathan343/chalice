...
the [Chalice repository on GitHub](https://github.com/aws/chalice/tree/master/docs/source/samples).
...
[Todo Application](todo-app/index.md)
...
: This app is a REST API that manages Todo
  ...
  implement auth and login with Chalice's [builtin authorizers](../topics/authorizers.md#builtin-authorizers).

[Media Query Application](media-query/index.md)
