...
See [Get certificate in AWS Certificate Manager](https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-custom-domains-prerequisites.html)
...
!!! note
    ...
    the [Custom Domain Names](../tutorials/customdomain.md) tutorial.
...
[dns last config](domainname.md#dns-last-config) section below.
...
[custom domain config options](configfile.md#custom-domain-config-options) section of the [Configuration File](configfile.md)
documentation.
...
[custom domain ws config options](configfile.md#custom-domain-ws-config-options) section of the [Configuration File](configfile.md)
documentation.
