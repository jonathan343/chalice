...
table as our data store. We'll be using the [AWS Cloud Development Kit (CDK)](https://aws.amazon.com/cdk/)
...
See the [Getting started with the AWS CDK](https://docs.aws.amazon.com/cdk/latest/guide/getting_started.html#getting_started_prerequisites)
...
on June 1, 2023. See
[Working with the AWS CDK in Python Doc](https://docs.aws.amazon.com/cdk/v2/guide/work-with-cdk-python.html)
...
We're using [httpie](https://httpie.io/) to make our HTTP requests from the
command line.
