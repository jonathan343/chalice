...
This is discussed in the [package 3rd party](packaging.md#package-3rd-party) section below.
...
See [Multifile Support](multifile.md) for more info on the `chalicelib/` directory. Both the
`app.py` and the `chalicelib/` directory are intended for code that you
write yourself.

<a id="package-3rd-party"></a>
## 3rd Party Packages
...
See the [package examples](packaging.md#package-examples) section for examples of how this works.
...
- **vendor/** - The *contents* of this directory are automatically added to
  ...
  [package auto layers](packaging.md#package-auto-layers) section.
...
the top level of the deployment package (see [package examples](packaging.md#package-examples) for
...
You can set the [automatic layer option](configfile.md#automatic-layer-option) in your `.chalice/config.json`
...
<img src="../img/no-auto-layer.png" alt="Default behavior with no layers." style="width: 50%;" />
...
<img src="../img/auto-layer.png" alt="Shared layer for 3rd party code." style="width: 80%;" />
...
[cryptography 1.9](https://pypi.org/project/cryptography/1.9/) package
