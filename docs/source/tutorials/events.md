...
In the [Quickstart](../quickstart.md) guide, we looked at how to create a
...
[Quickstart](../quickstart.md) for a step by step guide. In a nutshell, you can get a
...
[these instructions](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2.html)
...
on [Lambda Event Sources](../topics/events.md) for more details.
