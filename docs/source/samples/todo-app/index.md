...
[samples directory on GitHub](https://github.com/aws/chalice/tree/master/docs/source/samples/todo-app/code/).
...
!!! note
    This sample application is also available as a [workshop](https://chalice-workshop.readthedocs.io/en/latest/todo-app/index.html).
...
<img src="docs/assets/architecture.jpg" alt="Architecture diagram" style="width: 100%;" />

<a id="todo-sample-rest-api"></a>
### REST API
...
<a id="todo-app-rest-api"></a>
### Rest API

Below is the code for the five routes defined in the
[todo sample rest api](index.md#todo-sample-rest-api) section defined in the `app.py` file:
...
is discussed in more detail in the [todo app jwt auth](index.md#todo-app-jwt-auth) section below.
...
us to use the [high level querying interface of boto3](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/customizations/dynamodb.html#dynamodb-conditions).
...
[JWT](https://datatracker.ietf.org/doc/html/rfc7519) when you login.
...
through the [hashlib.pbkdf2_hmac](https://docs.python.org/3/library/hashlib.html#hashlib.pbkdf2_hmac)
...
[Authorization](../../topics/authorizers.md), and in this example we're using the
[builtin authorizers](../../topics/authorizers.md#builtin-authorizers) type provided by Chalice. This lets us write
...
[todo app rest api](index.md#todo-app-rest-api) section above. For example, note that the
